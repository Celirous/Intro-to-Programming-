...
function continueStory(answerNumber) {
    switch (answerNumber) {
        case 0:
            ...
            break;
        case 1:
            if (answers[1] === "GO TO MARS" || answers[1] ===  "GO") {
                story.innerHTML = document.getElementById("answer11").innerHTML;
                askQuestion(2);
            } else if (answers[1] === "STAY HOME" || answers[1] === "STAY") {
            ...
            break;
        case 2: 
            if (answers[2] === "RISK IT" || answers[2] === "RISK") {
                story.innerHTML = document.getElementById("answer21").innerHTML;
                theEnd();
            } else if (answers[2] === "GO HOME" || answers[2] === "GO") {
